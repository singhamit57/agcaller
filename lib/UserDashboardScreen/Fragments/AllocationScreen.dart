                  ...
                  builder: (BuildContext context) {
                    return Expanded(
                      child: AlertDialog(
                        ...
                        content: Text(
                            'Auto dialer will initiate calls directly from your registered sim. You can pause the auto dialer any time in the next screen.\nDial from?'),
                        actions: [
                          Column(
                            ...
                            children: [
                              OutlinedButton(
                                ...
                                child: Text(
                                  'My Allocation',
                                  style: TextStyle(color: logoColors),
                                ),
                              ),
                              SizedBox(
                                height: 10,
