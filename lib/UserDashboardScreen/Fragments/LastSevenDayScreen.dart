...
class LastSevenDayScreen extends StatefulWidget
{
  const LastSevenDayScreen({Key? key}) :super(key: key);
  @override
  _LastSevenDayScreenState createState()=>_LastSevenDayScreenState();
}
class _LastSevenDayScreenState extends State<LastSevenDayScreen>
{
