...
class AdvancedReportScreens extends StatefulWidget
{
  const AdvancedReportScreens({Key? key}) :super(key: key);
  _AdvancedReportScreensState createState()=>_AdvancedReportScreensState();

}
class _AdvancedReportScreensState extends State<AdvancedReportScreens>
{
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          SizedBox(height: 10,),
          Text('- Max date range allowed is 15 days.\n-Report can only be generated for the past\ndate (till yesterday).\n-All users should update the app to latest\nversion (data will be  available only for the calls made from the updated app)',
